...
export interface IEventEditorDialogProps
  extends StyledComponentProps<keyof ReturnType<typeof styles>> {
  fullScreen?: boolean;
  event?: IDayEvent;
  selectedDay?: Moment;
...
class EventEditorDialog extends Component<IEventEditorDialogProps, IState> {
  ...
  public handleEventDescriptionChange = (
  ...
  public handleEventNotificationChange = (
    event: ChangeEvent<HTMLInputElement>
  ) => {
    this.setState({
      event: {
  ...
  public render() {
    ...
    const {
      open,
      event: { description, time, title, notification }
    } = this.state;
    ...
    return (
      <div className={classes.root}>
        ...
        <Dialog fullScreen={fullScreen} open={open} onClose={this.handleClose}>
...
export default withStyles(styles)(
  withMobileDialog<IEventEditorDialogProps>({ breakpoint: 'xs' })(
    EventEditorDialog
  )
);
